...
*/
#if MANUAL_SIM_SELECTION
  {
    ...
    do
    {
        PMAWS_PRINTF("\rSelect the SIM slot (0 - External, 1 - Internal): \b");
        c = getchar();
    }
    while ( (c < '0')  || (c > '1'));
...
int updateWiFiCredentials(void)
{
  ...
  do
  {
      PMAWS_PRINTF("\rEnter Security Mode (0 - Open, 1 - WEP, 2 - WPA, 3 - WPA2): ");
      c = getchar();
  }
  while ( (c < '0')  || (c > '3'));
...
int updateTLSCredentials(void)
{
      ...
      || dialog_ask("\nDo you want to update the root CA certificate(s)? [y/n]\n") )
  {
    ...
    PMAWS_PRINTF("-----BEGIN CERTIFICATE-----\n");
    PMAWS_PRINTF("YMPGn8u67GB9t+aEMr5P+1gmIgNb1LTV+/Xjli5wwOQuvfwu7uJBVcA0Ln0kcmnL\n");
    PMAWS_PRINTF("R7EUQIN9Z/SG9jGr8XmksrUuEvmEF/Bibyc+E1ixVA0hmnM3oTDPb5Lc9un8rNsu\n");
    PMAWS_PRINTF(".......\n");
    PMAWS_PRINTF("-----END CERTIFICATE-----\n");
    PMAWS_PRINTF("-----BEGIN CERTIFICATE-----\n");
    PMAWS_PRINTF("YMPGn8u67GB9t+aEMr5P+1gmIgNb1LTV+/Xjli5wwOQuvfwu7uJBVcA0Ln0kcmnL\n");
    PMAWS_PRINTF(".......\n");
    PMAWS_PRINTF("-----END CERTIFICATE-----\n");
...
int updateFirmwareVersion()
{
  ...
  if (Button_WaitForPush(5000))
  {
    ...
    PMAWS_PRINTF("Downloading and programming the new firmware.\n");
